...
from timm.models.layers import create_conv2d, create_norm_layer, get_act_layer, get_norm_layer, ConvNormAct
from timm.models.layers import DropPath, trunc_normal_, to_2tuple, to_ntuple
...
def _cfg(url='', **kwargs):
    return {
        'url': url,
        'num_classes': 1000, 'input_size': (1, 224, 224), 'pool_size': None, 'fixed_input_size': True,
